...
impl UpdateEnrollmentResponseContent {
    ...
    pub fn new(created_at: String, id: String, payer: models::EnrolledPayerOutput, primary_contact: models::ProviderContact, provider: models::AllEnrolledProviderFields, status_last_updated_at: String, transactions: models::EnrolledTransactionsList, updated_at: String, user_email: String) -> UpdateEnrollmentResponseContent {
