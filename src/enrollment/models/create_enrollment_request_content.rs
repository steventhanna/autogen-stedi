...
pub struct CreateEnrollmentRequestContent {
    ...
    /// Information about the provider enrolling with the payer. You **must** use the [Create Provider](https://www.stedi.com/docs/api-reference/healthcare/post-enrollment-create-provider) endpoint to add the provider to Stedi before you can enroll them with one or more payers.
    ...
    pub status: Option<models::InitialEnrollmentStatus>,
...
impl CreateEnrollmentRequestContent {
    /// Input for CreateEnrollment.
    pub fn new(payer: models::EnrolledPayerInput, primary_contact: models::ProviderContact, provider: models::EnrolledProviderInput, transactions: models::EnrolledTransactionsList, user_email: String) -> CreateEnrollmentRequestContent {
