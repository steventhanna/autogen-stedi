...
impl GetEnrollmentResponseContent {
    ...
    pub fn new(created_at: chrono::DateTime<chrono::FixedOffset>, id: String, payer: models::EnrolledPayerOutput, primary_contact: models::ProviderContact, provider: models::AllEnrolledProviderFields, status_last_updated_at: chrono::DateTime<chrono::FixedOffset>, transactions: models::EnrolledTransactionsList, updated_at: chrono::DateTime<chrono::FixedOffset>, user_email: String) -> GetEnrollmentResponseContent {
