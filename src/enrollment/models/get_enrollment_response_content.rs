...
/// GetEnrollmentResponseContent : Output containing the enrollment details.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct GetEnrollmentResponseContent {
...
impl GetEnrollmentResponseContent {
    /// Output containing the enrollment details.
    pub fn new(created_at: String, id: String, payer: models::EnrolledPayerOutput, primary_contact: models::ProviderContact, provider: models::AllEnrolledProviderFields, status_last_updated_at: String, transactions: models::EnrolledTransactionsList, updated_at: String, user_email: String) -> GetEnrollmentResponseContent {
