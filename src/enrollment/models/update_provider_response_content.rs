...
/// UpdateProviderResponseContent : Output containing the updated provider details.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct UpdateProviderResponseContent {
...
impl UpdateProviderResponseContent {
    ...
    pub fn new(id: String, name: String, npi: String) -> UpdateProviderResponseContent {
