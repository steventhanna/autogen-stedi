...
/// ClaimSummary : The top-level fields of a claim.
...
impl ClaimSummary {
    ...
    pub fn new(id: String, patient_control_number: String, status: models::ClaimStatus, status_reported_by: models::ClaimStatusReportedBy, submitted_at: chrono::DateTime<chrono::FixedOffset>, total_claim_charge_amount: String, r#type: models::ClaimType) -> ClaimSummary {
        ClaimSummary {
