...
/// ProfessionalClaimSubmissionOrderingProviderIdentifiers : Identifiers for an ordering provider.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct ProfessionalClaimSubmissionOrderingProviderIdentifiers {
...
impl ProfessionalClaimSubmissionOrderingProviderIdentifiers {
    /// Identifiers for an ordering provider.
    pub fn new() -> ProfessionalClaimSubmissionOrderingProviderIdentifiers {
        ProfessionalClaimSubmissionOrderingProviderIdentifiers {
