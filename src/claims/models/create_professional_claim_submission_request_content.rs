...
/// CreateProfessionalClaimSubmissionRequestContent : The request to submit a professional claim.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct CreateProfessionalClaimSubmissionRequestContent {
