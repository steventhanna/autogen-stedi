...
/// ProfessionalClaimSubmissionData : A professional claim in the Stedi JSON format.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct ProfessionalClaimSubmissionData {
