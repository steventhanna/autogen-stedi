...
/// ProfessionalClaimSubmissionRenderingProviderIdentifiers : Identifiers for the rendering provider.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct ProfessionalClaimSubmissionRenderingProviderIdentifiers {
...
impl ProfessionalClaimSubmissionRenderingProviderIdentifiers {
    /// Identifiers for the rendering provider.
    pub fn new() -> ProfessionalClaimSubmissionRenderingProviderIdentifiers {
