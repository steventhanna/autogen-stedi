...
pub struct ListExecutionFaultsResponseContent {
    ...
    #[serde(rename = "items")]
    pub items: Vec<models::ExecutionFault>,
}

impl ListExecutionFaultsResponseContent {
    /// Common output structure for list operations with pagination support.
    pub fn new(items: Vec<models::ExecutionFault>) -> ListExecutionFaultsResponseContent {
