...
/// NotFoundExceptionResponseContent : The requested resource does not exist.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct NotFoundExceptionResponseContent {
    /// Why the request failed. The wording can change, so branch on the exception type, not this text.
    #[serde(rename = "message")]
    pub message: String,
}

impl NotFoundExceptionResponseContent {
    /// The requested resource does not exist.
    pub fn new(message: String) -> NotFoundExceptionResponseContent {
