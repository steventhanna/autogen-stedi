...
/// EligibilityCheckPreExistingCondition : Indicates coverage for this benefit is restricted because of a pre-existing condition.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct EligibilityCheckPreExistingCondition {
...
impl EligibilityCheckPreExistingCondition {
    /// Indicates coverage for this benefit is restricted because of a pre-existing condition.
    pub fn new(coverage_level: models::EligibilityCheckCoverageLevel) -> EligibilityCheckPreExistingCondition {
