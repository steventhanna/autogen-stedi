...
/// EligibilityCheckOtherSourceOfData : Indicates the information provided came from a source other than the payer's own system. Rarely returned.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct EligibilityCheckOtherSourceOfData {
...
impl EligibilityCheckOtherSourceOfData {
    /// Indicates the information provided came from a source other than the payer's own system. Rarely returned.
    pub fn new(coverage_level: models::EligibilityCheckCoverageLevel) -> EligibilityCheckOtherSourceOfData {
