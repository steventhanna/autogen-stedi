...
pub struct OtherPayerReferringProviderIdentifierItem {
...
impl OtherPayerReferringProviderIdentifierItem {
    pub fn new(identifier: String, qualifier: String) -> OtherPayerReferringProviderIdentifierItem {
        OtherPayerReferringProviderIdentifierItem {
            identifier,
