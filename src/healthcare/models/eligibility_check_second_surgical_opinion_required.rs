...
/// EligibilityCheckSecondSurgicalOpinionRequired : Indicates the plan requires a second surgical opinion before this benefit is available. This is a precondition for obtaining the benefit.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct EligibilityCheckSecondSurgicalOpinionRequired {
...
impl EligibilityCheckSecondSurgicalOpinionRequired {
    ...
    pub fn new(coverage_level: models::EligibilityCheckCoverageLevel) -> EligibilityCheckSecondSurgicalOpinionRequired {
