...
pub struct ClaimsServiceLineSupervisingProvider {
    ...
    pub secondary_identifier: Option<Vec<models::ServiceLineSupervisingProviderSecondaryIdentifierItem>>,
    /// The provider's SSN.
...
impl ClaimsServiceLineSupervisingProvider {
    pub fn new() -> ClaimsServiceLineSupervisingProvider {
