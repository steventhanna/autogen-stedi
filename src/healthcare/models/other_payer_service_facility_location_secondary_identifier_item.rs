...
pub struct OtherPayerServiceFacilityLocationSecondaryIdentifierItem {
...
impl OtherPayerServiceFacilityLocationSecondaryIdentifierItem {
    pub fn new(identifier: String, qualifier: String) -> OtherPayerServiceFacilityLocationSecondaryIdentifierItem {
        OtherPayerServiceFacilityLocationSecondaryIdentifierItem {
            identifier,
