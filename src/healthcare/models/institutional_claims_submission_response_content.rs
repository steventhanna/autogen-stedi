...
pub struct InstitutionalClaimsSubmissionResponseContent {
...
impl InstitutionalClaimsSubmissionResponseContent {
    pub fn new() -> InstitutionalClaimsSubmissionResponseContent {
