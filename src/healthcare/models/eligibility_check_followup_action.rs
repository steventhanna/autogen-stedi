...
/// EligibilityCheckFollowupAction : Payers may sometimes return other non-compliant values.
/// Payers may sometimes return other non-compliant values.
#[derive(Clone, Copy, Debug, Eq, PartialEq, Ord, PartialOrd, Hash, Serialize, Deserialize)]
pub enum EligibilityCheckFollowupAction {
    ...
    #[serde(rename = "Please Resubmit Original Transaction")]
...
impl std::fmt::Display for EligibilityCheckFollowupAction {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        match self {
            ...
            Self::PleaseResubmitOriginalTransaction => write!(f, "Please Resubmit Original Transaction"),
...
impl Default for EligibilityCheckFollowupAction {
    fn default() -> EligibilityCheckFollowupAction {
