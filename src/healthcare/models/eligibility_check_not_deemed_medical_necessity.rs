...
/// EligibilityCheckNotDeemedMedicalNecessity : Indicates the payer has determined this service isn't medically necessary and won't cover it on that basis.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct EligibilityCheckNotDeemedMedicalNecessity {
...
impl EligibilityCheckNotDeemedMedicalNecessity {
    /// Indicates the payer has determined this service isn't medically necessary and won't cover it on that basis.
    pub fn new(coverage_level: models::EligibilityCheckCoverageLevel) -> EligibilityCheckNotDeemedMedicalNecessity {
