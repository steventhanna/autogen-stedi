...
/// EligibilityCheckEligibilityStatus : Whether the patient has active or inactive coverage for a specific service, network, and coverage level. For example, active coverage for service type code `30` (Health Benefit Plan Coverage) at the individual coverage level.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct EligibilityCheckEligibilityStatus {
    ...
    #[serde(rename = "status")]
    pub status: models::EligibilityCheckCoverageStatus,
}

impl EligibilityCheckEligibilityStatus {
    ...
    pub fn new(coverage_level: models::EligibilityCheckCoverageLevel, status: models::EligibilityCheckCoverageStatus) -> EligibilityCheckEligibilityStatus {
