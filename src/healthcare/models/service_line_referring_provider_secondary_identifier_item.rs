...
pub struct ServiceLineReferringProviderSecondaryIdentifierItem {
...
impl ServiceLineReferringProviderSecondaryIdentifierItem {
    pub fn new(identifier: String, qualifier: String) -> ServiceLineReferringProviderSecondaryIdentifierItem {
        ServiceLineReferringProviderSecondaryIdentifierItem {
            identifier,
