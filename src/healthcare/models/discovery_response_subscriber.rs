...
/// DiscoveryResponseSubscriber : Common fields shared between subscriber and dependent structures in the eligibility response.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct DiscoveryResponseSubscriber {
    ...
    pub entity_identifier: Option<models::ResponseSubscriberEntityIdentifier>,
    ...
    pub insured_indicator: Option<models::SubscriberInsuredIndicator>,
    ...
    pub relation_to_subscriber: Option<models::SubscriberRelationship>,
    #[serde(rename = "relationToSubscriberCode", skip_serializing_if = "Option::is_none")]
    pub relation_to_subscriber_code: Option<models::SubscriberRelationshipCode>,
