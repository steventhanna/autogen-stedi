...
/// EligibilityCheckInvalidBenefit : An invalid benefit entry that Stedi couldn't include in the standard benefit arrays due to data validation issues. This structure includes all possible benefit properties (amount, percent, quantity) to capture what the payer actually sent.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct EligibilityCheckInvalidBenefit {
    ...
    pub invalid_reasons: Vec<models::EligibilityCheckInvalidEntryReason>,
...
impl EligibilityCheckInvalidBenefit {
    ...
    pub fn new(coverage_level: models::EligibilityCheckCoverageLevel, invalid_reasons: Vec<models::EligibilityCheckInvalidEntryReason>) -> EligibilityCheckInvalidBenefit {
