...
pub struct PrincipalDiagnosis {
    #[serde(rename = "presentOnAdmissionIndicator", skip_serializing_if = "Option::is_none")]
    pub present_on_admission_indicator: Option<models::PrincipalDiagnosisPresentOnAdmissionIndicator>,
    ...
    #[serde(rename = "principalDiagnosisCode")]
    pub principal_diagnosis_code: String,
    #[serde(rename = "qualifierCode")]
    pub qualifier_code: models::PrincipalDiagnosisQualifierCode,
}

impl PrincipalDiagnosis {
    pub fn new(principal_diagnosis_code: String, qualifier_code: models::PrincipalDiagnosisQualifierCode) -> PrincipalDiagnosis {
        PrincipalDiagnosis {
