...
pub enum ServiceLineSupplementalInformationAttachmentReportTypeCode {
    #[serde(rename = "03")]
    Variant03,
    #[serde(rename = "04")]
    Variant04,
...
impl std::fmt::Display for ServiceLineSupplementalInformationAttachmentReportTypeCode {
...
impl Default for ServiceLineSupplementalInformationAttachmentReportTypeCode {
    fn default() -> ServiceLineSupplementalInformationAttachmentReportTypeCode {
        Self::Variant03
    }
}
