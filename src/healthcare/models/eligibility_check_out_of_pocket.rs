...
/// EligibilityCheckOutOfPocket : An out-of-pocket maximum benefit entry. The `amount` is the limit on what the patient pays. The decimal precision reflects what the payer sent (e.g., `5000.0` or `5000`). Check `timePeriod` to determine whether an amount is the full maximum or the amount remaining.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct EligibilityCheckOutOfPocket {
...
impl EligibilityCheckOutOfPocket {
    ...
    pub fn new(amount: String, coverage_level: models::EligibilityCheckCoverageLevel) -> EligibilityCheckOutOfPocket {
