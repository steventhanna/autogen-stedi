...
pub struct ServiceLineOrderingProvider {
    ...
    pub contact_information: Option<Box<models::ContactInformationOrderingProvider>>,
    ...
    pub secondary_identifier: Option<Vec<models::ServiceLineOrderingProviderSecondaryIdentifierItem>>,
...
impl ServiceLineOrderingProvider {
    pub fn new() -> ServiceLineOrderingProvider {
