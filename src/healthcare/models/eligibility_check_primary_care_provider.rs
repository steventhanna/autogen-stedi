...
/// EligibilityCheckPrimaryCareProvider : The patient's assigned primary care provider (PCP). A PCP is the main healthcare provider responsible for managing a patient's care and coordinating referrals to specialists. When present, the provider's information is available in the `relatedEntities` array.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct EligibilityCheckPrimaryCareProvider {
...
impl EligibilityCheckPrimaryCareProvider {
    ...
    pub fn new(coverage_level: models::EligibilityCheckCoverageLevel) -> EligibilityCheckPrimaryCareProvider {
