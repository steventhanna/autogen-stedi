...
pub struct ServiceLineSupervisingProviderSecondaryIdentifierItem {
...
impl ServiceLineSupervisingProviderSecondaryIdentifierItem {
    pub fn new(identifier: String, qualifier: String) -> ServiceLineSupervisingProviderSecondaryIdentifierItem {
        ServiceLineSupervisingProviderSecondaryIdentifierItem {
            identifier,
