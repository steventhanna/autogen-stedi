...
pub struct DentalReportInformation {
    ...
    pub attachment_report_type_code: models::DentalAttachmentReportTypeCode,
...
impl DentalReportInformation {
    pub fn new(attachment_report_type_code: models::DentalAttachmentReportTypeCode, attachment_transmission_code: models::ReportInformationAttachmentTransmissionCode) -> DentalReportInformation {
