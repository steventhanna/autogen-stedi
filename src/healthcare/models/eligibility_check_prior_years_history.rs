...
/// EligibilityCheckPriorYearsHistory : Benefit information relating to a previous coverage year.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct EligibilityCheckPriorYearsHistory {
...
impl EligibilityCheckPriorYearsHistory {
    /// Benefit information relating to a previous coverage year.
    pub fn new(coverage_level: models::EligibilityCheckCoverageLevel) -> EligibilityCheckPriorYearsHistory {
