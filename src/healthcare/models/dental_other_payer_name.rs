...
/// DentalOtherPayerName : Details about the other payer.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct DentalOtherPayerName {
    /// The payer's address.
    ...
    #[serde(rename = "otherPayerPredeterminationIdentification", skip_serializing_if = "Option::is_none")]
    pub other_payer_predetermination_identification: Option<String>,
    /// The authorization number assigned by this payer.
...
impl DentalOtherPayerName {
    /// Details about the other payer.
    pub fn new(other_payer_identifier: String, other_payer_identifier_type_code: models::OtherPayerIdentifierTypeCode, other_payer_organization_name: String) -> DentalOtherPayerName {
        DentalOtherPayerName {
            ...
            other_payer_predetermination_identification: None,
