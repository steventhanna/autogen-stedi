...
/// EligibilityCheckCardReportedStolen : A fraud alert indicating the patient's insurance card was reported lost or stolen. This typically means that the payer has flagged the patient's member ID to prevent identity theft. The patient may still have active coverage, but you likely won't be able to run transactions with the patient's information until they resolve the issue.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct EligibilityCheckCardReportedStolen {
...
impl EligibilityCheckCardReportedStolen {
    ...
    pub fn new(coverage_level: models::EligibilityCheckCoverageLevel) -> EligibilityCheckCardReportedStolen {
