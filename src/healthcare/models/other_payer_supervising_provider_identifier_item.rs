...
pub struct OtherPayerSupervisingProviderIdentifierItem {
...
impl OtherPayerSupervisingProviderIdentifierItem {
    pub fn new(identifier: String, qualifier: String) -> OtherPayerSupervisingProviderIdentifierItem {
        OtherPayerSupervisingProviderIdentifierItem {
            identifier,
