...
/// InstitutionalDelayReasonCode : Code indicating the reason for the delay in claim submission. Visit [Claims code lists](https://www.stedi.com/docs/healthcare/claims-code-lists#delay-reason-codes) for a complete list.
...
pub enum InstitutionalDelayReasonCode {
    #[serde(rename = "1")]
    Variant1,
    #[serde(rename = "2")]
    Variant2,
...
impl std::fmt::Display for InstitutionalDelayReasonCode {
...
impl Default for InstitutionalDelayReasonCode {
    fn default() -> InstitutionalDelayReasonCode {
        Self::Variant1
    }
}
