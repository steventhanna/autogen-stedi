...
pub struct OtherPayerBillingProviderIdentifierItem {
...
impl OtherPayerBillingProviderIdentifierItem {
    pub fn new(identifier: String, qualifier: String) -> OtherPayerBillingProviderIdentifierItem {
        OtherPayerBillingProviderIdentifierItem {
            identifier,
