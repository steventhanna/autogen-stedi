...
pub struct PatientReasonForVisit {
    ...
    #[serde(rename = "patientReasonForVisitCode")]
    pub patient_reason_for_visit_code: String,
    #[serde(rename = "qualifierCode")]
    pub qualifier_code: models::PatientReasonForVisitQualifierCode,
}

impl PatientReasonForVisit {
    pub fn new(patient_reason_for_visit_code: String, qualifier_code: models::PatientReasonForVisitQualifierCode) -> PatientReasonForVisit {
