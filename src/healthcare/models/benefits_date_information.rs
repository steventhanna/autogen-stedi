...
pub struct BenefitsDateInformation {
    ...
    pub admissions: Option<Vec<models::DtpDate>>,
    /// The benefit date.
    ...
    pub discharges: Option<Vec<models::DtpDate>>,
    ...
    #[serde(rename = "latestVisitOrConsultation", skip_serializing_if = "Option::is_none")]
