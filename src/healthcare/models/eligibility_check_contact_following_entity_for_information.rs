...
/// EligibilityCheckContactFollowingEntityForInformation : Indicates that the payer can't supply the information you requested and is directing you to another entity. The entity's information is listed in the `relatedEntities` array.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct EligibilityCheckContactFollowingEntityForInformation {
...
impl EligibilityCheckContactFollowingEntityForInformation {
    ...
    pub fn new(coverage_level: models::EligibilityCheckCoverageLevel) -> EligibilityCheckContactFollowingEntityForInformation {
