...
/// EligibilityCheckServicesRestrictedToFollowingProvider : Indicates the benefit is available only when delivered by a particular provider, identified in `relatedEntities`. This doesn't confirm whether that provider is in or out of network with the payer.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct EligibilityCheckServicesRestrictedToFollowingProvider {
...
impl EligibilityCheckServicesRestrictedToFollowingProvider {
    ...
    pub fn new(coverage_level: models::EligibilityCheckCoverageLevel) -> EligibilityCheckServicesRestrictedToFollowingProvider {
