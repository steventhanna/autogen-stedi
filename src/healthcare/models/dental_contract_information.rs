...
/// DentalContractInformation : Required when the submitter is contractually obligated to supply this information on post-adjudicated claims.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct DentalContractInformation {
    ...
    pub contract_type_code: models::DentalContractInformationContractTypeCode,
...
impl DentalContractInformation {
    /// Required when the submitter is contractually obligated to supply this information on post-adjudicated claims.
    pub fn new(contract_type_code: models::DentalContractInformationContractTypeCode) -> DentalContractInformation {
