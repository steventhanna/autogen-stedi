...
impl std::fmt::Display for OtherPayerBillingProviderEntityTypeQualifier {
...
impl Default for OtherPayerBillingProviderEntityTypeQualifier {
    fn default() -> OtherPayerBillingProviderEntityTypeQualifier {
        Self::Variant1
    }
}
