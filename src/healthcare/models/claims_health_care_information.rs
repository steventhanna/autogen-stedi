...
pub struct ClaimsHealthCareInformation {
    ...
    pub diagnosis_type_code: models::ClaimsDiagnosisTypeCode,
}

impl ClaimsHealthCareInformation {
    pub fn new(diagnosis_code: String, diagnosis_type_code: models::ClaimsDiagnosisTypeCode) -> ClaimsHealthCareInformation {
