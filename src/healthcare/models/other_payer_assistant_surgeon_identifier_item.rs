...
pub struct OtherPayerAssistantSurgeonIdentifierItem {
...
impl OtherPayerAssistantSurgeonIdentifierItem {
    pub fn new(identifier: String, qualifier: String) -> OtherPayerAssistantSurgeonIdentifierItem {
        OtherPayerAssistantSurgeonIdentifierItem {
            identifier,
