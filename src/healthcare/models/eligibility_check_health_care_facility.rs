...
/// EligibilityCheckHealthCareFacility : Identifies a medical facility associated with the benefit, typically indicating an institution or provider network the patient is required or expected to use. The facility's information is available in the `relatedEntities` array. Rarely returned.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct EligibilityCheckHealthCareFacility {
...
impl EligibilityCheckHealthCareFacility {
    ...
    pub fn new(coverage_level: models::EligibilityCheckCoverageLevel) -> EligibilityCheckHealthCareFacility {
