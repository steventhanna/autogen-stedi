...
/// EligibilityCheckOtherOrAdditionalPayer : Indicates another payer that has coverage responsibility for the patient. This is the signal for coordination of benefits (COB) scenarios. The other payer's details are available in the `relatedEntities` array.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct EligibilityCheckOtherOrAdditionalPayer {
...
impl EligibilityCheckOtherOrAdditionalPayer {
    ...
    pub fn new(coverage_level: models::EligibilityCheckCoverageLevel) -> EligibilityCheckOtherOrAdditionalPayer {
