...
/// EligibilityCheckCannotProcess : Indicates that the payer couldn't process your request. A common cause is requesting benefits information for a service type or procedure code the payer doesn't support.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct EligibilityCheckCannotProcess {
...
impl EligibilityCheckCannotProcess {
    ...
    pub fn new(coverage_level: models::EligibilityCheckCoverageLevel) -> EligibilityCheckCannotProcess {
