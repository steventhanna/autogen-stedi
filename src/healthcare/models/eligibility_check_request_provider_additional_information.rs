...
/// EligibilityCheckRequestProviderAdditionalInformation : Additional identification numbers for the provider. Only include when specifically required by a payer.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct EligibilityCheckRequestProviderAdditionalInformation {
    ...
    pub state_license: Option<Box<models::EligibilityCheckRequestStateLicense>>,
...
impl EligibilityCheckRequestProviderAdditionalInformation {
    /// Additional identification numbers for the provider. Only include when specifically required by a payer.
    pub fn new() -> EligibilityCheckRequestProviderAdditionalInformation {
        EligibilityCheckRequestProviderAdditionalInformation {
