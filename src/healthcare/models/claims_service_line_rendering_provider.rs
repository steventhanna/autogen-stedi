...
pub struct ClaimsServiceLineRenderingProvider {
    ...
    pub secondary_identifier: Option<Vec<models::ServiceLineRenderingProviderSecondaryIdentifierItem>>,
...
impl ClaimsServiceLineRenderingProvider {
    pub fn new() -> ClaimsServiceLineRenderingProvider {
