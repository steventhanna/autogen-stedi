...
pub struct InstitutionalClaimsRawX12SubmissionResponseContent {
    #[serde(rename = "claimReference", skip_serializing_if = "Option::is_none")]
    pub claim_reference: Option<Box<models::InstitutionalClaimReference>>,
    ...
    pub errors: Option<Vec<models::InstitutionalError>>,
    ...
    pub meta: Option<Box<models::InstitutionalResponseMeta>>,
    #[serde(rename = "payer", skip_serializing_if = "Option::is_none")]
    pub payer: Option<Box<models::InstitutionalPayer>>,
...
impl InstitutionalClaimsRawX12SubmissionResponseContent {
    pub fn new() -> InstitutionalClaimsRawX12SubmissionResponseContent {
