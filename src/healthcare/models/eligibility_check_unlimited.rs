...
/// EligibilityCheckUnlimited : Indicates that there's no limit for the benefit. For example, unlimited physical therapy visits or unlimited preventive care.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct EligibilityCheckUnlimited {
...
impl EligibilityCheckUnlimited {
    ...
    pub fn new(coverage_level: models::EligibilityCheckCoverageLevel) -> EligibilityCheckUnlimited {
