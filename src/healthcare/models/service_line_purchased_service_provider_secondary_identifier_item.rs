...
pub struct ServiceLinePurchasedServiceProviderSecondaryIdentifierItem {
...
impl ServiceLinePurchasedServiceProviderSecondaryIdentifierItem {
    pub fn new(identifier: String, qualifier: String) -> ServiceLinePurchasedServiceProviderSecondaryIdentifierItem {
        ServiceLinePurchasedServiceProviderSecondaryIdentifierItem {
            identifier,
