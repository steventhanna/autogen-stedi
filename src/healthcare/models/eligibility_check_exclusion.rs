...
/// EligibilityCheckExclusion : A service or condition the plan doesn't cover for any patient. This is different from a `nonCovered` entry, which reports that this patient doesn't have coverage for a specific service you submitted in the request.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct EligibilityCheckExclusion {
...
impl EligibilityCheckExclusion {
    ...
    pub fn new(coverage_level: models::EligibilityCheckCoverageLevel) -> EligibilityCheckExclusion {
