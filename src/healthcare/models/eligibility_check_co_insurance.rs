...
/// EligibilityCheckCoInsurance : A co-insurance benefit entry. The `percent` is the patient's share of costs, expressed as a decimal (such as `0.8` for 80%). The decimal precision reflects what the payer sent. A value of `0` indicates the payer reported no co-insurance responsibility.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct EligibilityCheckCoInsurance {
...
impl EligibilityCheckCoInsurance {
    ...
    pub fn new(coverage_level: models::EligibilityCheckCoverageLevel, percent: String) -> EligibilityCheckCoInsurance {
