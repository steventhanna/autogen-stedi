...
/// EligibilityCheckBenefitDescription : A payer-authored description of a benefit. Payers sometimes use this type to communicate information that's difficult to capture elsewhere in the response. The description is included as free text in `messages` or identifiers in `additionalInformation`.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct EligibilityCheckBenefitDescription {
...
impl EligibilityCheckBenefitDescription {
    ...
    pub fn new(coverage_level: models::EligibilityCheckCoverageLevel) -> EligibilityCheckBenefitDescription {
