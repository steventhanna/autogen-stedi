...
pub struct ClaimsServiceLineReferringProvider {
    ...
    pub secondary_identifier: Option<Vec<models::ServiceLineReferringProviderSecondaryIdentifierItem>>,
...
impl ClaimsServiceLineReferringProvider {
    pub fn new() -> ClaimsServiceLineReferringProvider {
