...
pub struct RawEligibilityResponseValidationErrors {
    ...
    pub meta: Option<Box<models::EligibilityMetaDataRawX12>>,
...
impl RawEligibilityResponseValidationErrors {
    pub fn new() -> RawEligibilityResponseValidationErrors {
