...
/// CrossoverCarrier : Information about the crossover carrier. The crossover carrier is defined as any payer to which the claim is transferred for further payment after the current payer has finalized it.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct CrossoverCarrier {
