...
pub struct ServiceLineOrderingProviderSecondaryIdentifierItem {
...
impl ServiceLineOrderingProviderSecondaryIdentifierItem {
    pub fn new(identifier: String, qualifier: String) -> ServiceLineOrderingProviderSecondaryIdentifierItem {
        ServiceLineOrderingProviderSecondaryIdentifierItem {
            identifier,
