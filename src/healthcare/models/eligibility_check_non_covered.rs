...
/// EligibilityCheckNonCovered : Indicates that the patient's plan doesn't cover a specific service type you submitted in the eligibility check. Note that the absence of a `nonCovered` entry doesn't mean that a specific service is covered.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct EligibilityCheckNonCovered {
...
impl EligibilityCheckNonCovered {
    ...
    pub fn new(coverage_level: models::EligibilityCheckCoverageLevel) -> EligibilityCheckNonCovered {
