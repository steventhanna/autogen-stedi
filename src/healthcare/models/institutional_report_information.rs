...
pub struct InstitutionalReportInformation {
    ...
    pub attachment_report_type_code: models::ReportInformationAttachmentReportTypeCode,
    ...
    pub attachment_transmission_code: models::InstitutionalReportInformationAttachmentTransmissionCode,
}

impl InstitutionalReportInformation {
    pub fn new(attachment_report_type_code: models::ReportInformationAttachmentReportTypeCode, attachment_transmission_code: models::InstitutionalReportInformationAttachmentTransmissionCode) -> InstitutionalReportInformation {
