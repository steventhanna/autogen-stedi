...
impl std::fmt::Display for InstitutionalRelationshipToSubscriberCode {
...
impl Default for InstitutionalRelationshipToSubscriberCode {
    fn default() -> InstitutionalRelationshipToSubscriberCode {
        Self::Variant01
    }
}
