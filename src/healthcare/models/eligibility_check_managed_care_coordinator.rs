...
/// EligibilityCheckManagedCareCoordinator : A care coordinator associated with the patient's managed care arrangement. When present, the care coordinator's details are in the `relatedEntities` array.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct EligibilityCheckManagedCareCoordinator {
...
impl EligibilityCheckManagedCareCoordinator {
    ...
    pub fn new(coverage_level: models::EligibilityCheckCoverageLevel) -> EligibilityCheckManagedCareCoordinator {
