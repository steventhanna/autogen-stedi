...
impl PayerRecord {
    pub fn new(aliases: Vec<String>, display_name: String, names: Vec<String>, primary_payer_id: String, stedi_id: String, transaction_support: models::TransactionSupport) -> PayerRecord {
        PayerRecord {
            aliases,
            avatar_url: None,
            coverage_types: None,
