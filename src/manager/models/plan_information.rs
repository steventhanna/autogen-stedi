...
pub struct PlanInformation {
    ...
    #[serde(rename = "centersForMedicareAndMedicaidServicesNPI", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "facilityNetworkIdentificationNumber", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "planNetworkIdDescription", skip_serializing_if = "Option::is_none")]
