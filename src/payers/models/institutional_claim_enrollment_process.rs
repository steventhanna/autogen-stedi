...
/// InstitutionalClaimEnrollmentProcess : Details about the enrollment process for institutional claim submission.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct InstitutionalClaimEnrollmentProcess {
...
impl InstitutionalClaimEnrollmentProcess {
    /// Details about the enrollment process for institutional claim submission.
    pub fn new() -> InstitutionalClaimEnrollmentProcess {
