...
/// ElectronicFundsTransferEnrollmentProcess : Details about the enrollment process for Electronic Funds Transfer (EFT).
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct ElectronicFundsTransferEnrollmentProcess {
...
impl ElectronicFundsTransferEnrollmentProcess {
    /// Details about the enrollment process for Electronic Funds Transfer (EFT).
    pub fn new() -> ElectronicFundsTransferEnrollmentProcess {
        ElectronicFundsTransferEnrollmentProcess {
