...
/// ClaimPaymentAdviceWithElectronicFundsTransferEnrollmentProcess : Details about the enrollment process for Electronic Remittance Advice (ERA) with Electronic Funds Transfer (EFT).
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct ClaimPaymentAdviceWithElectronicFundsTransferEnrollmentProcess {
...
impl ClaimPaymentAdviceWithElectronicFundsTransferEnrollmentProcess {
    /// Details about the enrollment process for Electronic Remittance Advice (ERA) with Electronic Funds Transfer (EFT).
    pub fn new() -> ClaimPaymentAdviceWithElectronicFundsTransferEnrollmentProcess {
        ClaimPaymentAdviceWithElectronicFundsTransferEnrollmentProcess {
