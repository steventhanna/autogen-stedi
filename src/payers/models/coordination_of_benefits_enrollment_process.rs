...
/// CoordinationOfBenefitsEnrollmentProcess : Details about the enrollment process for coordination of benefits (COB) checks.
#[derive(Clone, Default, Debug, PartialEq, Serialize, Deserialize)]
pub struct CoordinationOfBenefitsEnrollmentProcess {
...
impl CoordinationOfBenefitsEnrollmentProcess {
    /// Details about the enrollment process for coordination of benefits (COB) checks.
    pub fn new() -> CoordinationOfBenefitsEnrollmentProcess {
